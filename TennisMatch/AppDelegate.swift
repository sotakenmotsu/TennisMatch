...
class AppDelegate: UIResponder, UIApplicationDelegate, GIDSignInDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if display.size.height == CGFloat(568) {
            let storyboard = UIStoryboard(name: "5SLogin",
                                          bundle: nil)
            ...
            if userDefaults.object(forKey: "idToken") != nil {
                if userDefaults.object(forKey: "accessToken") != nil {
                    ...
                    let storyboard = UIStoryboard(name: "5SMain",
                                                  bundle: nil)
        ...
        if #available(iOS 10.0, *) {
            ...
            let settings: UIUserNotificationSettings = UIUserNotificationSettings(types: [.alert,
                                                                                          .badge,
                                                                                          .sound],
                                                                                  categories: nil)
